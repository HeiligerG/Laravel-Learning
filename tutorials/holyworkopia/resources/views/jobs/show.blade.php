<x-layout>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="rounded-lg shadow-md bg-white p-3">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-3 ml-4">
                        ...
                        >
                        <!-- Delete Form -->
                        <form method="POST" action="{{route('jobs.destroy', $job->id)}}" onsubmit="return confirm('Are you sure to delete this Job?')">
                            @csrf
                            @method('DELETE')
                            <button
                                type="submit"
                    ...
                    <div x-data="{ open: false }" id="applicant-form">
                        ...
                        @else
                            <p class="my-5 bg-gray-200  rounded p-3">
                                ...
                                You must be logged in to Apply to a job.
                            </p>
                        @endauth
                    </div>
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            @guest
                <p class="mt-10 bg-gray-200 text-grey-700 font-bold w-full py-2 px-4 rounded-full text-center">
                    <i class="fas fa-info-circle mr-3"></i>
