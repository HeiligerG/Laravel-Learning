<x-layout>
    ...
    >
        ...
        >
            ...
            <x-inputs.text id="title" name="title" label="Job Title" placeholder="Software Engeneer"/>
            ...
            <x-inputs.text id="company_name" name="company_name" label="Company" placeholder="Enter Company Name"/>
            ...
            <x-inputs.text id="company_website" name="company_website" label="Company Website" type="url" placeholder="Enter Company Name"/>
