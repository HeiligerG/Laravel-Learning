<x-layout>
    ...
    >
        ...
        >
            ...
            <x-inputs.text id="title" name="title" label="Job Title" placeholder="Software Engeneer" :value="old('title', $job->title)"/>
            ...
            <x-inputs.select id="remote" name="remote" label="Remote" :value="old('job_type', $job->job_type)" :options="[0 => 'No', 1 => 'Yes']"/>
            ...
            <x-inputs.text id="company_name" name="company_name" label="Company" placeholder="Enter Company Name" :value="old('company_name', $job->company_name)"/>
            ...
            <x-inputs.text id="company_website" name="company_website" label="Company Website" type="url" placeholder="Enter Company Name" :value="old('company_website', $job->company_website)"/>
